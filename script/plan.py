...
# gate = Gates(BASEPATH+"gates/gates_n5.yaml")
gate = Gates()
# gate.add_gate([ 0, 1, -1])
# gate.add_gate([-1, 0, -1])
# gate.add_gate([ 0,-1, -1])
...
gate.add_gate([0,0,-0.4])
gate.add_gate([-3.9,-1.6,-1.55])
gate.add_gate([-7.3,0,-0.4])
gate.add_gate([-9.5,1.36,-1.22])
gate.add_gate([-9.2,-1.52,-1.32])
gate.add_gate([-6.8,0.45,-1.33])
gate.add_gate([-3.94,1.35,-1.2])
