...
from plotting import plot_track_vel
...
plot_track_vel(gates, traj_topt, traj_track, traj_track_mpc, np.array(gates._pos[0]))

plt.savefig(BASEPATH+"figs/track_vel.eps")
